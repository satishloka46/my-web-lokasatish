pipeline {
  ...
  stages {
    ...
    stage('deployment on tomcat') {
      steps {
        sh """
             wget --http-user=${env.jfrog_user}  --http-password=${env.jfrog_pass} https://satishloka4666.jfrog.io/artifactory/com/mycompany/app/my-app-lokasatish/2.0/my-app-lokasatish-2.0.war
